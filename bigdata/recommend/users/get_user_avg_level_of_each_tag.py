...
df = pd.DataFrame(columns = ['handle', 'math', 'implementation', 'greedy', 'string', 'dataStructure', 'graphs', 'dp', 'bruteforcing', 'math_cnt', 'implementation_cnt', 'greedy_cnt', 'string_cnt', 'dataStructure_cnt', 'graphs_cnt', 'dp_cnt', 'bruteforcing_cnt'])
tag_list = ['math', 'implementation', 'greedy', 'string', 'dataStructure', 'graphs', 'dp', 'bruteforcing']
...
df.to_csv(file_path + 'user_avg_level_of_tags.csv')